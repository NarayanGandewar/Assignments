...
public class CommentsInJava {
	...
	/**
     * This is the main method � the starting point of execution for any Java program.
     * 
     * <p>
     * Important Notes:
     * </p>
     * <ul>
     *   <li><strong>public:</strong> Makes the method accessible to the JVM.</li>
     *   <li><strong>static:</strong> Allows calling without creating an object of the class.</li>
     *   <li><strong>void:</strong> Doesn't return any value.</li>
     *   <li><strong>String[] args:</strong> Accepts command-line arguments.</li>
     * </ul>
     * 
